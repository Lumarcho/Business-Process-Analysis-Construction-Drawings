...
Identify inefficiencies, delays, and root causes.
Understand stakeholder roles, needs, and challenges.
Compare the current process with a desired TO-BE state.
...
Revising drawings based on feedback
Obtaining client approval
Preparing final drawings
Producing distribution copies
Sending drawings to clients and contractors
...
Disorganised archives
Limited staff training
Weak IT governance and underinvestment
...
Upgrading CAD software and computer hardware
Implementing a cloud-based digital document management system
Introducing automated version control
Replacing unreliable printing and scanning equipment
Using structured digital approval workflows
Standardising requirement, feedback, and approval templates
Digitising archives and improving file naming conventions
Training staff on digital tools and workflow management
...
Upgrade CAD software and computers.
Train staff on digital tools.
Standardise requirement and feedback templates.
Medium term: 6–18 months

Implement a digital document management system.
Introduce version control and digital approvals.
Digitise legacy archives.
Long term: 18–36 months

Move toward BIM-enabled collaboration.
Strengthen IT governance using frameworks such as COBIT or ISO 38500.
...
Improve drawing accuracy and version control.
Increase client and contractor satisfaction.
Improve staff productivity and morale.
Reduce reliance on paper, printing, and couriers.
Lower operational and project risks.
